...
hide the ~/.urxvt/urxvtd-hostname directory

add the follow code to your ~/.zshrc in you using the zsh shell,
or if you are using another shell add the code to the shell config file
