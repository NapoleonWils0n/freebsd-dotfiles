...
color browser-directory = 8

## Sets the text color of playlists in the browser
color browser-playlist = 4

## Set the color of the progress indicator.
color progressbar = 8/4
color progressbar-background = 4/8

## Set the text color used to display mpd status in the status window.
color status-state = 0,bold
